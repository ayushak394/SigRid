        ...
        <div className="container flex h-20 items-center justify-between">
          ...
          {isMenuOpen && (
            <motion.div
              ...
              className="fixed top-0 left-0 w-full h-full z-40 bg-white md:hidden overflow-y-auto pt-20"
            >
              <ul className="flex flex-col items-center gap-8 text-lg py-8">
                {navItems.map((item) => (
                  <motion.li
                    key={item.section}
          ...
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
              ...
              <p className="text-lg text-slate-600">
                A new chapter, free from nicotine addiction
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
                    ...
                    <Card className="bg-white/90 backdrop-blur-sm shadow-lg">
                      <CardContent className="p-6">
                        ...
                        <p className="text-slate-700">
                          At SigRid, we believe quitting nicotine is not only
                          about stopping a habit — it's about helping people
                          heal their health, their relationships, and their
                          lives.
                        </p>
                      </CardContent>
                    </Card>
              ...
              >
                <p className="text-lg text-slate-700">
                  Our first product — the Nicotine Nasal Spray — is specially
                  designed to give quick relief from cravings. Research shows
                  that fast-acting support helps people avoid relapse and stay
                  committed to quitting. Our goal is to provide healthcare
                  professionals with effective tools that make it easier for
                  patients to break free from addiction.
                </p>

                <p className="text-lg text-slate-700">
                  We are proud to work alongside India's healthcare community to
                  build a healthier, stronger, nicotine-free future. Together,
                  we can bring real change — one patient, one family, and one
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <p className="text-lg text-slate-700">
                  At SigRid, we believe nicotine addiction is not just a health
                  problem — it affects a person's mind, family, relationships,
                  and overall quality of life. In India, according to the Global
                  Adult Tobacco Survey (GATS-2), around 28.6% of adults use
                  tobacco, and many struggle silently with the harmful effects
                  of nicotine.
                </p>

                <p className="text-lg text-slate-700">
                  Along with serious health risks like cancer, heart disease,
                  and lung problems, nicotine addiction often causes emotional
                  stress, family issues, financial problems, and mental health
                  challenges like anxiety and depression.
                </p>

                <p className="text-lg text-slate-700">
                  Doctors, nurses, and healthcare workers across India see these
                  effects every day. We started SigRid because we saw an urgent
                  need for better, faster solutions to help patients quit
                  nicotine successfully.
                </p>
              </motion.div>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-8">
                    <Card className="bg-white/90 backdrop-blur-sm shadow-lg">
                      <CardContent className="p-6">
                        ...
                        <p className="text-slate-700">
                          To provide effective tools that make it easier for
                          patients to break free from nicotine addiction and
                          reclaim their lives.
                        </p>
                      </CardContent>
                    </Card>
          ...
          <div className="container">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <p className="text-lg text-slate-600">
                  Tracking key metrics helps us measure the urgency of our
                  mission in fighting nicotine addiction and helping people quit
                  smoking for a healthier future. Every day, thousands of lives
                  are lost to tobacco-related illnesses.
                </p>
                    ...
                    <CardContent className="p-6">
                      <div className="space-y-1">
                        ...
                        <p className="text-sm text-slate-600">
                          Deaths from Tobacco Use Per Year
                        </p>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-8">
                    <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-lg">
                      ...
                      <p className="text-slate-700">
                        ...
                        can take for your health. Within just 20 minutes of
        ...
        <section id="features" className="py-24 bg-white">
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-slate-900">
                Features That Make{" "}
                <span className="text-teal-600">The Difference</span>
              </h2>

              <p className="text-lg text-slate-600">
                Our innovative approach to smoking cessation combines
                cutting-edge technology with deep understanding of addiction
                psychology.
              </p>
            </div>
                ...
                >
                  <div className="h-full rounded-xl bg-white border border-slate-200 shadow-md hover:shadow-xl transition-all duration-300 group-hover:translate-y-[-5px]">
                    <div className="p-6 space-y-4">
                      <div
                        className={`h-14 w-14 rounded-xl ${feature.color} flex items-center justify-center mb-4`}
                      >
                        {feature.icon}
                      </div>
            ...
            <div className="mt-20">
              ...
              >
                <div className="absolute inset-0 z-0">
                  <Image
                    src="/ProductPicBackground.png"
                    alt="SigRid Product Banner"
                    fill
                    className="object-cover"
                  />
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                      <h3 className="text-3xl font-bold">
                        Ready to Experience the SigRid Difference?
                      </h3>
                      <p className="text-lg text-teal-50">
                        Join thousands of successful quitters who have
                        transformed their lives with our revolutionary product.
                      </p>
        ...
        >
          <div className="container space-y-20">
            <div className="text-center max-w-3xl mx-auto space-y-6">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-slate-900">
                How to <span className="text-teal-600">Use SigRid</span>{" "}
                Effectively
              </h2>

              <p className="text-lg text-slate-600">
                Follow these simple steps to maximize the effectiveness of
                SigRid and support your journey to becoming smoke-free.
              </p>
            </div>
                ...
                <div className="space-y-10">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600">
                        Before using SigRid for the first time, prime the spray
                        by pumping it several times until a fine mist appears.
                        Hold the bottle upright with your thumb at the bottom
                        and your index and middle fingers on either side of the
                        nozzle.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600">
                        Tilt your head back slightly and insert the tip of the
                        bottle into one nostril, pointing toward the back of
                        your nose, not upward. Block the other nostril with your
                        finger.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600">
                        Breathe in gently through your nose while pressing
                        firmly on the pump to release one spray. Wait a few
                        minutes before using in the other nostril if needed.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600">
                        Use 1-2 sprays per nostril when you feel a craving
                        coming on, with a maximum of 5 doses per hour and 40
                        doses per day. Gradually reduce usage over the 12-week
                        program.
                      </p>
                    </div>
                  </div>
                  ...
                  <ul className="space-y-5">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-indigo-800">
                        Avoid sniffing, swallowing, or inhaling deeply while
                        spraying
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="h-5 w-5 text-indigo-600 mt-0.5 flex-shrink-0" />
                      <span className="text-indigo-800">
                        Use when cravings start, not after they're intense
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="h-5 w-5 text-indigo-600 mt-0.5 flex-shrink-0" />
              ...
              >
                ...
                <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                  ...
                  <p className="text-slate-600 mb-4">
                    Our video tutorial provides a detailed visual guide to using
                    SigRid correctly. Proper technique ensures maximum
                    effectiveness and comfort during use.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-teal-600 mt-0.5 flex-shrink-0" />
                      <span className="text-slate-700">
                        See proper technique demonstrated by experts
                      </span>
                    </li>
                  </ul>
                </div>
        ...
        <section id="testimonials" className="py-24 bg-white">
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
              ...
              <p className="text-lg text-slate-600">
                Hear from people who have successfully quit smoking with SigRid
                    ...
                    <div className="flex flex-col h-full">
                      ...
                      <div className="p-6 flex-grow space-y-4">
                        ...
                        <p className="text-slate-700 italic text-lg p-2">
                          "Thanks to Sigrid, I finally managed to kick the
                  ...
                  <CardContent className="p-0 h-full">
                    <div className="flex flex-col h-full">
                      ...
                      <div className="p-6 flex-grow space-y-4">
                        ...
                        <p className="text-slate-700 italic text-lg p-2">
                          "I have been using Sigrid for 2 weeks now, and I have
                          almost stopped smoking cigarettes. Whenever I feel the
                          need to smoke, I use the spray, and the cravings go
                          away."
                        </p>
                      </div>
                    </div>
                  ...
                  <CardContent className="p-0 h-full">
                    <div className="flex flex-col h-full">
                      ...
                      <div className="p-6 flex-grow space-y-4">
                        ...
                        <p className="text-slate-700 italic text-lg p-2">
                          "I started smoking as my work got very stressful.
                          Thanks to Sigrid, I no longer have to be awkward in my
                          workplace."
                        </p>
                      </div>
                    </div>
        ...
        <section id="faq" className="py-24 bg-white">
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-slate-900">
                Common <span className="text-teal-600">Questions</span> About
                SigRid
              </h2>
          ...
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-10 space-y-3">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900">
                We're Here To{" "}
                <span className="text-teal-600">Support Your Journey</span>
              </h2>
              <p className="text-base text-slate-600">
                Have questions about SigRid or need support with your smoking
                cessation journey? Our team of experts is ready to help you
      ...
      <footer className="py-1 bg-black bg-opacity-82 mt-10">
        <div className="container max-w-6xl mx-auto px-2 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 border-t border-[#c8d8d0] pt-10">
            <div className="md:col-span-5 grid grid-cols-2 gap-8">
              <div className="space-y-3">
                <h4 className="text-m font-normal uppercase tracking-widest text-white">
                  Useful Links{" "}
                </h4>
                <ul className="space-y-2">
                  <li>
                    <Link
                      href="#"
                      className="transition-colors tracking-wide  text-sm font-light  text-white"
                    >
                      Home
                    </Link>
                  </li>
                  <li>
                    <Link
                      href="#about-us"
                      className=" text-white transition-colors tracking-wide  text-sm font-light"
                    >
                      About Us
                    </Link>
                  </li>
              ...
              <div className="space-y-3">
                <h4 className="text-m font-normal text-white uppercase tracking-widest">
                  Help
                </h4>
                <ul className="space-y-2">
                  <li>
            ...
            <div className="md:col-span-7 md:pl-10 md:border-l border-[#c8d8d0] space-y-6">
              <p className=" text-white text-base font-light leading-snug">
                SigRid delivers the nicotine in lower quantities than you
                generally get from cigarettes or other tobacco products. Your
                body gradually adapts to lower levels of nicotine until you no
                longer need any, thus helping you quit.
              </p>
              <div className="flex items-center">
                <div className="h-px flex-grow bg-[#c8d8d0]"></div>
                <div className="mx-4 text-white uppercase">
                  A step closer towards victory
                </div>
                <div className="h-px flex-grow bg-[#c8d8d0]"></div>
              </div>
            </div>
          ...
          <div className="text-center pt-6 border-t border-[#c8d8d0]">
            <p className=" text-white text-xs tracking-[0.2em] uppercase font-light pb-2">
              © 2025 BY SIGRID
            </p>
          </div>
        </div>
